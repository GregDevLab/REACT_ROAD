...
const Login = () => {
	...
	return (
		<div className='flex place-items-center justify-center h-[100%]'>	
			<div className='hidden sm:block sm:w-[50%] h-[500px] max-h-[100%] bg-[url("login.png")] bg-[length:100%_100%] bg-center bg-no-repeat lg:border-solid border-2 lg:border-sky-500 lg:border-r-0'></div>
